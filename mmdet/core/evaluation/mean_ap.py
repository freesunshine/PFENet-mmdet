...
#
#             out_list.append([thr / 20, eval_results[0]['ap'], eval_results[0]['recall'][-1], eval_results[1]['ap'],
#                              eval_results[1]['recall'][-1], mean_ap])
#         print(iou_thr)
#         print_map_summary(
#             mean_ap, eval_results, dataset, area_ranges, logger=logger)
#
#     f = open('/home/wangyong/Code/mmdet-pol/work_dirs/iou-courves/person-car2/iou(300).csv', 'w')
#     for ln in out_list:
#         f.write(str(ln[0]))
#         f.write(',')
#         f.write(str(ln[1]))
